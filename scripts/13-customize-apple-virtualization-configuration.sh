...
[[ $(utmctl list | wc -l | xargs) -ne "1" ]] && error_exit "Ensure No Virtual Machines Exist Before Updating Configuration"
...
CURRENT_HOST_NET_ADDRESS=$(sudo /usr/libexec/PlistBuddy -c "print :Host_Net_Address" /Library/Preferences/SystemConfiguration/com.apple.vmnet.plist)
CURRENT_HOST_NET_MASK=$(sudo /usr/libexec/PlistBuddy -c "print :Host_Net_Mask" /Library/Preferences/SystemConfiguration/com.apple.vmnet.plist)
