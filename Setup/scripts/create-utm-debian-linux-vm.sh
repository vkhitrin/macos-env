...
# Variable definition
UTM_VIRTUAL_MACHINE_DISPLAY_NAME=${UTM_VIRTUAL_MACHINE_DISPLAY_NAME:-debian\-linux\-00}
...
/usr/libexec/PlistBuddy -c 'add :System:Boot:LinuxKernelPath string linux' "$UTM_VIRTUAL_MACHINE_BUNDLE_PATH/config.plist"
/usr/libexec/PlistBuddy -c 'add :System:Boot:LinuxInitialRamdiskPath string initrd.gz' "$UTM_VIRTUAL_MACHINE_BUNDLE_PATH/config.plist"
...
/usr/libexec/PlistBuddy -c 'add :Information:Icon string debian' "$UTM_VIRTUAL_MACHINE_BUNDLE_PATH/config.plist"
...
print_padded_title "UTM - Download External Debian Linux Binaries"
curl 'https://deb.debian.org/debian/dists/bookworm/main/installer-arm64/current/images/netboot/debian-installer/arm64/linux' -so "$UTM_VIRTUAL_MACHINE_BUNDLE_PATH/Data/linux"
curl 'https://deb.debian.org/debian/dists/bookworm/main/installer-arm64/current/images/netboot/debian-installer/arm64/initrd.gz' -so "$UTM_VIRTUAL_MACHINE_BUNDLE_PATH/Data/initrd.gz"
